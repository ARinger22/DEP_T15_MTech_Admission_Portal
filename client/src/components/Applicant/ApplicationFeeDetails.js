...
function ApplicationFeeDetails(props) {
  return (
    <div>
      <div className="px-8 py-8 md:px-20 md:py-20 mx-auto my-10 md:my-20 bg-[#f3f4f6] rounded-2xl">        <div className="mt-10 sm:mt-0">
                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  ...
                  <div className="my-4 flex flex-wrap justify-between items-center">
                    <button
                      ...
                      className="border border-transparent shadow-sm text-sm font-medium rounded-md text-white justify-center block py-2 px-4 mr-2 mb-2 sm:mb-0 sm:mr-4 items-center bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" style={{ width: "120px", height: "40px" }}
                    >
                      Back
                    </button>
                    <button
