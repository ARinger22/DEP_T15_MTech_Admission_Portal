...
function ChevronDots({
  ...
  let progressClass = `absolute top-1/2 left-0 h-2 transform -translate-y-1/2 bg-blue-600 transition-width ease-in-out duration-500`;
  ...
  return (
    <div className={finalClass} {...newProps}>
      <div className="h-3px sm:h-2px w-full bg-gray-300 relative">
        <div
