...
export default function ChartBarGender(props) {
  useEffect(() => {
    let config = {
      type: "bar",
      data: {
    ...
    let ctx = document.getElementById("bar-chart-gender").getContext("2d");
      ...
      <CardHeader color="teal" contentPosition="between">
        <div className="flex justify-between">
          <div>
            ...
            <h2 className="text-white text-2xl">Gender-Wise Applications</h2>
          </div>
          <div>
            <select
              required
